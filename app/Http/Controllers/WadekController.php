...
class WadekController extends Controller
{
    ...
    public function penjaminanmutuprodiwadek(Request $request)
    {
        $request->validate([
    ...
    public function validasiseluruhprodiwadek(Request $request)
    {
        $request->validate([
        ...
        if ($updatedRows > 0) {
            session()->put('suksesvalidasiseluruhprodiwadek', 'Validasi berhasil! Semua prodi pada fakultas ini di periode SPMI terpilih telah divalidasi.');
        } else {
            session()->put('gagalvalidasiseluruhprodiwadek', 'Gagal validasi! Tidak ada data penilaian ditemukan untuk fakultas ini di periode yang dipilih.');
        }
    ...
    public function validasisatuanwadek(Request $request)
    {
    ...
    public function validasisatuanbatalwadek(Request $request)
    {
        $spmipenilaianindikatorcalc = Spmipenilaianindikatorscalc::where([
            'spmi_penilaianprodis_id' => $request->input('spmi_penilaianprodis_id'),
            'spmi_indikators_id' => $request->input('spmi_indikators_id')
    ...
    public function validasisemuawadek(Request $request)
    {
        $spmi_penilaianprodis_id = $request->input('spmi_penilaianprodis_id');
    ...
    public function validasisemuabatalwadek(Request $request)
    {
        $spmi_penilaianprodis_id = $request->input('spmi_penilaianprodis_id');
        $spmi_indikators_ids = $request->input('spmi_indikators_id'); // ini array dari input
        $programstudi_id = $request->input('programstudi');
