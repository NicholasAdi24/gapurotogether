...
class Lp2mpController extends Controller
{

    public function monitorpenilaianlp2mp(Request $request)
    {
        ...
        return view('monitorpenilaianlp2mp', compact('userroles', 'data', 'allFakultas', 'allPeriode'));
    }


    public function penjaminanmutuprodilp2mp(Request $request)
    {
        $request->validate([
