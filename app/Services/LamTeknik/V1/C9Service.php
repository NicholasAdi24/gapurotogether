...
class C9Service
{
    ...
    public function c94a5(array $lulusan,  $strata)
    {
        ...
        if (($lts4 + $lts3 + $lts2 + $lts1 + $lts) > 0) {
            if ($strata == "S2") {
                ...
                // S1
                $MS = ((3.5 * $lts3) + (5 * $lts2) + (6 * $lts1) + (7 * $lts) + (8 * $mts)) / ($lts3 + $lts2 + $lts1 + $lts);
            }
        } else {
            $MS = 0;
        }
    ...
    //perlu cek ulang s1 s2 s3 d4 beda"
    ...
    {
        $b1 = 0.06; //ganti sesuai excel s1 d4
        $b2 = 0.45; //ganti sesuai excel s1 d4
    ...
    // S1 S2 D4
    public function c94a10(array $lulusan, array $lulusanterlacak, array $kesesuaianlulusan, $strata)
    {
    ...
    public function c94b2($NA, $NB, $NC, $ND, $strata)
    {
        if ($strata == "D4") {
            $b = 1;
        } else if ($strata == "S2") {
