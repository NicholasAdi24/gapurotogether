    ...
    <div class="navbar-logo">
      ...
      <a class="navbar-brand me-1 me-sm-3" href="{{route('landingpage')}}">
        <div class="d-flex align-items-center">
          <div class="d-flex align-items-center"><img src="{{ asset('templates/assets/img/icons/logo new.png') }}" alt="phoenix" width="27" />
            <p class="logo-text ms-2 d-none d-sm-block">GAPURO</p>
          </div>
        </div>
      </a>
    </div>
    ...
    <ul class="navbar-nav navbar-nav-icons flex-row">
              ...
              <div class="scrollbar-overlay" style="height: 27rem;">
                ...
                <div class="border-300">
                  <div class="px-2 px-sm-3 py-3 border-300 notification-card position-relative unread border-bottom">
                    <div class="d-flex align-items-center justify-content-between position-relative">
                      <div class="d-flex">
                        <div class="avatar avatar-m status-online me-3"><img class="rounded-circle" src="{{ asset('templates/assets/img/team/40x40/57.webp') }}" alt="" /></div>
                        <div class="flex-1 me-sm-3">
                  ...
                  <div class="px-2 px-sm-3 py-3 border-300 notification-card position-relative unread border-bottom">
                    <div class="d-flex align-items-center justify-content-between position-relative">
                      <div class="d-flex">
                        <div class="avatar avatar-m status-online me-3"><img class="rounded-circle" src="../assets/img/team/40x40/Undipcek.png" alt="" /></div>
                        <div class="flex-1 me-sm-3">
      ...
      <li class="nav-item dropdown"><a class="nav-link lh-1 pe-0" id="navbarDropdownUser" href="#!" role="button" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-haspopup="true" aria-expanded="false">
          <div class="avatar avatar-l ">
            <img class="rounded-circle " src="{{ asset('templates/assets/img/team/40x40/57.webp') }}" alt="" />
          </div>
        </a>
            ...
            <div class="card-body p-0">
              <div class="text-center pt-4 pb-3">
                <div class="avatar avatar-xl ">
                  <img class="rounded-circle " src="{{ asset('templates/assets/img/team/72x72/57.webp') }}" alt="" />
                </div>
