    ...
    <div class="row g-4">
        ...
        <div class="col-12">
            <div class="mb-8" style="text-align: center;">
                <h2 class="mb-2">Monitor Penilaian</h2>
                <h5 class="text-700 fw-semi-bold">Informasi Penilaian dalam Sistem Gapuro</h5>
            </div>

            <form method="GET" action="{{ route('monitorpenilaianlp2mp') }}" class="mb-3">
                ...
                <div class="mt-2">
                    <a href="{{ route('monitorpenilaianlp2mp') }}" class="btn btn-danger">Reset</a>
                </div>
            </form>
            ...
            <table class="table table-bordered" style="text-align: center;">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <form action="{{ route('penjaminanmutuprodilp2mp') }}" method="POST">
                                @csrf
