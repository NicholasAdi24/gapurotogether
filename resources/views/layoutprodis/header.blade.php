                        ...
                        <div class="card position-relative border-0">
                            <div class="card-body p-0">
                                <div class="text-center pt-4 pb-3">
                                    ...
                                    <h6 class="mt-2 text-black">{{ session()->get('user')->name }}
                                    </h6>
                                </div>
                            ...
                            <div class="overflow-auto scrollbar" style="height: 4rem;">
                                <ul class="nav d-flex flex-column mb-2 pb-1">
                                    <li class="nav-item"><a class="nav-link px-3" href="{{ route('changepassword') }}"> <span
                                                class="me-2 text-900" data-feather="lock"></span>Change Password</a></li>
                                </ul>
                            </div>
