                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped table-sm fs--1 mb-0">
                                        ...
                                        <tbody class="list">
                                            ...
                                            @php
                                                    $masaakhir = date_create($akreditasiinternasional->masa_akhir);
                                            ...
                                            <tr class="{{ $color }}">
                                                ...
                                                <td class="align-middle kode_prodi">{{ $akreditasiinternasional->Getprogramstudi->nama_prodi }}</td>
                                                <td class="align-middle nama_prodi">{{ $akreditasiinternasional->no_sk}}</td>
                                                <td class="align-middle strata">
                                                    {{$akreditasiinternasional->tahun }}</td>
                                                <td class="align-middle fakultas"> {{$akreditasiinternasional->masa_mulai}}</td>
                                                <td class="align-middle fakultas"> {{$akreditasiinternasional->masa_akhir}}</td>
                                                <td class="align-middle fakultas"> {{$akreditasiinternasional->akreditasi}}</td>
                                                <td class="align-middle fakultas">
                                                    <a href="{{ asset(@$akreditasiinternasional->berkas) }}" target="_blank" class="btn btn-sm btn-primary ">
                                                        <i class="fa fa-file"></i>
                                                    </a>
                                                </td>
                                                <td class="align-middle fakultas"> {{$akreditasiinternasional->lembaga}}</td>
