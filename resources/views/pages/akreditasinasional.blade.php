                    ...
                    <div class="card-header p-4 border-bottom border-300 bg-soft">
                        <div class="row g-3 justify-content-between align-items-end">
                            <div class="col-12 col-md">
                                <h4 class="text-900 mb-0" data-anchor="data-anchor">Daftar Akreditasi Nasional</h4>
                                <p class="mb-0 mt-2 text-800">Daftar <code>Akreditasi Nasional Program Studi</code> Di Universitas
                                    Diponegoro</p>
                            </div>
                                    ...
                                    <table class="table table-striped table-sm fs--1 mb-0">
                                        ...
                                        <tbody class="list">
                                            <?php
                                                $no = 1;
                                            ?>
                                            @foreach($akreditasinasionals as $akreditasinasional)
                                                @php
                                                    $masaakhir = date_create($akreditasinasional->masa_akhir);
                                            ...
                                            <tr class="{{ $color }}">
                                                ...
                                                <td class="align-middle kode_prodi">{{ @$akreditasinasional->Getprogramstudi->nama_prodi }}</td>
                                                <td class="align-middle nama_prodi">{{ $akreditasinasional->no_sk}}</td>
                                                <td class="align-middle strata">
                                                    {{$akreditasinasional->tahun }}</td>
                                                <td class="align-middle fakultas"> {{$akreditasinasional->masa_mulai}}</td>
                                                <td class="align-middle fakultas"> {{$akreditasinasional->masa_akhir}}</td>
                                                <td class="align-middle fakultas"> {{$akreditasinasional->akreditasi}}</td>
                                                <td class="align-middle fakultas">
                                                    <a href="{{ asset(@$akreditasinasional->berkas) }}" target="_blank" class="btn btn-sm btn-primary ">
                                                        <i class="fa fa-file"></i>
                                                    </a>
                                                </td>
                                                <td class="align-middle fakultas"> {{$akreditasinasional->lembaga}}</td>
