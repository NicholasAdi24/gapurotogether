                    ...
                    <div class="card-header p-4 border-bottom border-300 bg-soft">
                        <div class="row g-3 justify-content-between align-items-end">
                            <div class="col-12 col-md">
                                <h4 class="text-900 mb-0" data-anchor="data-anchor">Daftar Role</h4>
                                <p class="mb-0 mt-2 text-800">Daftar <code>Role</code> Di Universitas DIponegoro</p>
                            </div>
                    ...
                    <div class="card-body p-0">
                        <div class="p-4 code-to-copy">
                            <div id="tableExample3"
                                data-list='{"valueNames":["nomor","name"],"page":25,"pagination":true}'>
                                    ...
                                    <table class="table table-striped table-sm fs--1 mb-0">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="sort border-top" data-sort="name">Nama</th>
                                        ...
                                        <tbody class="list">
                                            ...
                                            <tr>
                                                ...
                                                <td class="align-middle name">{{$role->name}}</td>
