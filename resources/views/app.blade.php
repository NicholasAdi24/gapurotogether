...
<head>
    ...
    <link rel="apple-touch-icon" sizes="180x180"
        href="{{asset('templates/assets/img/favicons/apple-touch-icon new.png') }}">
    <link rel="icon" type="image/png" sizes="32x32"
        href="{{asset('templates/assets/img/favicons/favicon-32x32 new.png') }}">
    <link rel="icon" type="image/png" sizes="16x16"
        href="{{asset('templates/assets/img/favicons/favicon-16x16 new.png') }}">
...
<body>
    ...
    <script src="{{asset('templates/vendors/isotope-layout/isotope.pkgd.min.js') }}"></script>
    <script src="{{asset('templates/vendors/isotope-packery/packery-mode.pkgd.min.js') }}"></script>
    <script src="{{asset('templates/vendors/bigpicture/BigPicture.js') }}"></script>
    <script src="{{asset('templates/vendors/countup/countUp.umd.js') }}"></script>
    <script
