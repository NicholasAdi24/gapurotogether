    ...
    <div class="row g-4">
        ...
        <div class="col-12">
            <div class="mb-8" style="text-align: center;">
                ...
                <h5 class="mb-2 text-600 fw-semi-bold">Sedang Ditugaskan</h5>
            </div>

            <div class="mb-3 d-flex justify-content-start gap-2">
                <form action="{{ route('daftarpengisianauditselesai') }}" method="GET">
                    @csrf
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <form action="{{ route('penjaminanmutuauditor') }}" method="POST">
                                @csrf
                                <input type="hidden" name="id_prodi" value="{{ $item->programstudis_id }}">
                                <input type="hidden" name="id_spmi_periodes" value="{{ $item->spmi_periodes_id }}">
                                <button class="btn btn-primary w-100 fw-bold mb-3">
                                    Audit Mutu
                                </button>
                            </form>
                            @if ($item->status == 9)
                            <form action="{{ route('penjaminanmutuauditorselesai') }}" method="POST">
                                @csrf
